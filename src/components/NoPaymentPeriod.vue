    ...
    <b-form @submit="onSubmit" @reset="onReset" v-if="show">
      ...
      <b-row>
        ...
        <b-col cols="2">
          <b-form-group
            id="input-group-5"
            label="No Pay Period Start:"
            label-for="input-2"
          >
            <b-form-input
              id="input-2"
              v-model="form.noPeriodStart"
              required
              type="number"
              min="0"
            ></b-form-input>
      ...
      <b-row>
        <b-col class="slidecontainer" cols="4">
          <label for="customRange1">No Interest Pay Count</label>
          <input
            type="range"
            min="1"
            max="100"
...
export default {
  data() {
    return {
      ...
      noPayFrqs: ["Monthly", "Quarterly", "Be", "Replaced"],
